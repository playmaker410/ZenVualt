...
const actionCards = [
    { label: 'Irs Refund', icon: <RefreshCw size={24} />, bg: 'bg-zen-light-card dark:bg-zen-card', iconColor: 'text-zen-light-muted dark:text-zen-muted', textColor: undefined },
    { label: 'To Bank', icon: <Landmark size={24} />, bg: 'bg-blue-500', iconColor: 'text-white', textColor: 'text-white' },
    { label: 'Deposit', icon: <PlusCircle size={24} />, bg: 'bg-green-50 dark:bg-green-900/20', iconColor: 'text-green-500', textColor: undefined },
    { label: 'Atm Card', icon: <CreditCard size={24} />, bg: 'bg-purple-50 dark:bg-purple-900/20', iconColor: 'text-purple-500', textColor: undefined },
]
...
const mobileServices = [
    { label: 'Loan', icon: <Landmark size={20} />, bg: 'bg-purple-50 dark:bg-purple-900/20', color: 'text-purple-500' },
    { label: 'International wire', icon: <ArrowRight size={20} />, bg: 'bg-blue-50 dark:bg-blue-900/20', color: 'text-blue-500' },
    { label: 'Local wire', icon: <Send size={20} />, bg: 'bg-green-50 dark:bg-green-900/20', color: 'text-green-500' },
    { label: 'Transactions', icon: <History size={20} />, bg: 'bg-yellow-50 dark:bg-yellow-900/20', color: 'text-yellow-500' },
    { label: 'Add money', icon: <PlusCircle size={20} />, bg: 'bg-green-50 dark:bg-green-900/20', color: 'text-green-500' },
    { label: 'ATM card', icon: <CreditCard size={20} />, bg: 'bg-red-50 dark:bg-red-900/20', color: 'text-red-500' },
    ...
    return (
        <div className='xl:hidden'>
            ...
            <div className='grid grid-cols-3 gap-2'>
                {visible.map(({ label, icon, bg, color }) => (
                    <button key={label} className='flex flex-col items-center gap-2 p-3 rounded-xl bg-zen-light-card dark:bg-zen-card border border-zen-light-border dark:border-zen-border hover:opacity-80 transition'>
...
const ActionCard = ({ label, icon, bg, iconColor, textColor = 'text-zen-light-text dark:text-zen-text' }) => (
    <button className={`${bg} rounded-xl p-2 xl:p-6 flex flex-col items-center gap-2 xl:gap-3 w-full hover:opacity-90 transition`}>
                ...
                <main className='flex-1 overflow-y-auto p-4 xl:p-6 space-y-5'>
                    ...
                    <div>
                        <div className='grid grid-cols-4 gap-3 xl:gap-4'>
                            {actionCards.map(({ label, icon, bg, iconColor, textColor }) => (
                                <ActionCard key={label} label={label} icon={icon} bg={bg} iconColor={iconColor} textColor={textColor} />
                            ))}
                        </div>
                    </div>
