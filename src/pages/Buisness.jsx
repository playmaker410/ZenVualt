        ...
        <div className='bg-zen-light-bg dark:bg-zen-bg px-4 '>
            ...
            <div className='xl:flex xl:p-12  xl:justify-between'>
                ...
                <div className='flex flex-col gap-2 w-full' >
                    <p className='text-2xl xl:text-5xl font-bold '>Business</p>
                    <div className='flex justify-self-start w-fit'>
                        <NavLink to="/" className="">Home </NavLink>
                        <ChevronRight />
                        <NavLink to="/buisness" className={({ isActive }) => ` xl:text-lg ${isActive ? ' text-blue-500' : ''}`}> Business</NavLink>
                    </div>
            ...
            <div className='grid xl:grid-cols-2 xl:place-items-end xl:mx-[12.5rem]'>
                ...
                <div className=' order-1 xl:order-1'>
                    <img src={assets.Buisness} alt="" className='rounded h-auto w-full' />
                </div>

                <div className='flex flex-col gap-7 text-bold w-full xl:w-100 p-5 bg-[#f9f9f9] dark:bg-[#0a0a0a] rounded-md shadow-[0_4px_20px_rgba(0,0,0,0.08)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.4)] border border-gray-200/40 dark:border-white/10 order-3 xl:order-2  '>
                ...
                <div className='py-25 order-2 xl:order-3 '>
                    ...
                    <div>
                        <p className='text-2xl xl:text-3xl font-bold mb-5 '>Business</p>
