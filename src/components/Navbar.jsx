...
<div className={`fixed lg:hidden top-0 left-0 w-[80%]  h-dvh px-4 pt-10 bg-white dark:bg-gray-900 z-50 flex flex-col gap-2 font-semibold dark:text-white text-black  transition-all duration-800 ${
