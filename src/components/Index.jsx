...
import { Check, DollarCircle, ListUl, ChartTrend, Bell, ChevronLeft, ChevronRight, UserCircle, CalendarAlt, ArrowRightStroke } from '@boxicons/react'
...
const Index = ({ }) => {
  ...
  const visibleCount = windowWidth >= 1280 ? 3 : windowWidth >= 640 ? 2 : 1
    ...
    <div className='py-20 px-3 sm:px-10 lg:px-24 xl:px-40 w-full dark:text-white bg-zen-light-gradient dark:bg-zen-gradient'>
      ...
      <div className='grid xl:grid-cols-2 gap-10'>
        <div>
          ...
          <button className='bg-sky-400 hover:bg-blue-950 transition-colors active:scale-105 mt-3.5 px-9 py-3 xl:py-5 
      ...
      <section className='pt-10 xl:pt-20'>
        <div>
          <p className='text-center text-blue-500 font-semibold xl:leading-5'>Why Zenvault</p>
          <h1 className='text-center font-bold xl:text-6xl text-3xl'>Global Payment Solutions</h1>
        </div>
        ...
        <div className='py-12 grid md:grid-cols-3 gap-7 text-black'>
          ...
          >
            <div className={`absolute inset-x-0 bottom-0 bg-zen-glow transition-all duration-500 ease-in-out group-hover:h-full ${activeCard === 1 ? 'h-full' : 'h-0'}`}></div>
          ...
          <div
            ...
            className='group relative overflow-hidden flex flex-col items-center 
              ...
              dark:border-zen-border dark:text-zen-text cursor-pointer'
          >
            <div className={`absolute inset-x-0 bottom-0 bg-zen-glow transition-all duration-500 ease-in-out group-hover:h-full ${activeCard === 2 ? 'h-full' : 'h-0'}`}></div>
          ...
          <div
            ...
            className='group relative overflow-hidden flex flex-col items-center 
              ...
              dark:border-zen-border dark:text-zen-text cursor-pointer'
          >
            <div className={`absolute inset-x-0 bottom-0 bg-zen-glow transition-all duration-500 ease-in-out group-hover:h-full ${activeCard === 3 ? 'h-full' : 'h-0'}`}></div>
      ...
      {/* ====================================================================Smart Banking ====================================================================== */}
      <section className='grid xl:grid-cols-2 py-20 gap-16'>
        <div className='w-full relative'>
          <img src={assets.happybanking} alt="" className='relative z-10 rounded-2xl w-full object-cover' />
          <img src={assets.bgimage1} alt="" className='absolute -bottom-10 -right-5 z-0 w-52 sm:w-44 xl:w-fit dark:hidden' />
        </div>
        <div className='flex flex-col justify-center gap-4'>
          <p className='text-blue-500 font-semibold'>Smart Banking</p>
          <h1 className='text-3xl sm:text-4xl xl:text-5xl font-extrabold'>We Create Seamless Financial Experiences</h1>
          <p className='font-light text-zen-muted pb-6'>
          ...
          <div className='flex flex-col gap-4 mt-2'>
            <p className='flex gap-3 items-center'><Check fill='white' className='rounded-full bg-[#1E3A8A] w-6 h-6 shrink-0' />Cards that work all across the world.</p>
            <p className='flex gap-3 items-center'><Check fill='white' className='rounded-full bg-[#1E3A8A] w-6 h-6 shrink-0' />Unlock Greater Investment Potential</p>
            <p className='flex gap-3 items-center'><Check fill='white' className='rounded-full bg-[#1E3A8A] w-6 h-6 shrink-0' />No ATM Fees. No Minimum Balance. No Overdraft Charges.</p>
          </div>
        </div>
      </section>

      {/* ==========================================================================WHY CHOOSE US ============================================================================== */}
      <section className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 py-20 gap-8 sm:py-10'>
      ...
      <section className='grid xl:grid-cols-2 py-20 gap-16'>
        <div className='w-full relative order-2'>
          <img src={assets.security} alt="" className='relative z-10 rounded-2xl w-fit object-contain' />
        </div>
        <div className='flex flex-col justify-center gap-4 order-1'>
          <p className='text-blue-500 font-semibold'>Banking Protection</p>
          <h1 className='text-3xl sm:text-4xl xl:text-5xl font-extrabold'>Your Benefits</h1>
          <p className='font-light text-zen-muted pb-3'>Your one-stop digital banking platform.</p>
          <div className='flex flex-col gap-4'>
            <p className='flex gap-3 items-center'><Check fill='white' className='rounded-full bg-[#1E3A8A] w-6 h-6 shrink-0' />Global Coverage</p>
            <p className='flex gap-3 items-center'><Check fill='white' className='rounded-full bg-[#1E3A8A] w-6 h-6 shrink-0' />Easy Transfer Method</p>
            <p className='flex gap-3 items-center'><Check fill='white' className='rounded-full bg-[#1E3A8A] w-6 h-6 shrink-0' />Global 24/7 Support</p>
            <p className='flex gap-3 items-center'><Check fill='white' className='rounded-full bg-[#1E3A8A] w-6 h-6 shrink-0' />Lowest Fee</p>
            <p className='flex gap-3 items-center'><Check fill='white' className='rounded-full bg-[#1E3A8A] w-6 h-6 shrink-0' />Instant Processing</p>
            <p className='flex gap-3 items-center'><Check fill='white' className='rounded-full bg-[#1E3A8A] w-6 h-6 shrink-0' />Bank Level Security</p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className='flex flex-col justify-center items-center gap-2'>
          ...
          <h1 className='text-center font-bold xl:text-5xl text-3xl mx-auto max-w-3xl'>
        ...
        <div className='py-12 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-7 overflow-hidden'>
          {reviews
            ...
            .map((review, i) => (
              <div
                key={review.name}
                className={`bg-light-card-gradient dark:bg-card-col-gradient rounded-2xl p-5 flex-col gap-4 h-full
      ...
      <section className='py-15'>
        <div className='flex flex-col justify-center items-center gap-2'>
          <p className='text-blue-500 font-semibold'>Latest Insights From ZadexCore</p>
          <h1 className='text-center font-bold xl:text-5xl text-3xl mx-auto max-w-3xl'>
            Our Latest Article
          </h1>
        </div>
        ...
        <div>
          <div className='py-12 grid sm:grid-cols-2 xl:grid-cols-3 gap-4 overflow-hidden'>

            <div className='rounded-2xl p-3 flex flex-col gap-4 h-full '>
              <img src={assets.blog1} alt="" className='object-contain w-full hover:scale-105 ' />
              <a href="#" className='text-2xl font-bold'>What Consumer Expect From Commercial Loan</a>
              <p className='inline-flex gap-3 font-light'> <UserCircle />  Reanne Carnation | <CalendarAlt />  12 May, 2026</p>
              <a href='' className='inline-flex gap-3'> Read More <ArrowRightStroke /> </a>
            </div>

            <div className='rounded-2xl p-3 flex flex-col gap-4 h-full '>
              <img src={assets.blog2} alt="" className='object-contain w-full hover:scale-105  ' />
              <a href="#" className='text-2xl font-bold'>NSI Bank Will Close Their ATM From Tomorrow</a>
              <p className='inline-flex gap-3 font-light'> <UserCircle />  Reanne Carnation | <CalendarAlt />  12 May, 2026</p>
              <a href='' className='inline-flex gap-3'> Read More <ArrowRightStroke /> </a>
            </div>
            ...
            <div className='rounded-2xl p-3 flex flex-col gap-4 h-full '>
              <img src={assets.blog3} alt="" className='object-contain w-full hover:scale-105  ' />
              <a href="#" className='text-2xl font-bold'>The Fedaral Bank Appoints New Director To Board</a>
              <p className='inline-flex gap-3 font-light'> <UserCircle />  Reanne Carnation | <CalendarAlt />  12 May, 2026</p>
              <a href='' className='inline-flex gap-3'> Read More <ArrowRightStroke /> </a>
            </div>
